...
const About = forwardRef((props,ref) => {
  return (
  <WaveDiv svg={waveReverse} smallSvg={waveSmallReverse} reverse={true}  ref={ref} id="second-div">
     <motion.div initial={{opacity:0,y:-50}} animate={props.value === 'second-div' &&  {opacity:1, y:0}} transition={{delay:.2, ease:'easeInOut'}}>
        <VStack  p={{base:'5px 10px',sm:'5px 10vw'}} m={'auto'} alignItems={'center'} color={'#c6cfff'} justifyContent={'center'} minH={'100vh'} maxW={'1800px'}>
